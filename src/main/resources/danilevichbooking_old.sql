...
CREATE TABLE `apartment` (
  ...
  `count_guest` int(11) DEFAULT NULL,
...
INSERT INTO `apartment` (`id`, `name`, `description`, `room_size`, `count_guest`, `price`, `hotel_id`, `name_en`, `description_en`) VALUES
...
INSERT INTO `apartmentfacility` (`id`, `facility_id`, `apartment_id`) VALUES
(7, 5, 12),
(8, 5, 19),
(9, 5, 20),
(10, 5, 21),
...
INSERT INTO `city` (`id`, `name`, `country_id`, `name_en`) VALUES
(1, 'Минск', 2, 'Minsk'),
...
INSERT INTO `facility` (`id`, `name`, `name_en`) VALUES
(5, 'Wi-Fi', 'Wi-Fi'),
(6, 'Утюг', 'Iron'),
...
INSERT INTO `hotel` (`id`, `name`, `name_en`, `address`, `address_en`, `description`, `description_en`, `city_id`) VALUES
...
ALTER TABLE `apartment`
  ...
  ADD KEY `fk_apartment_hotel1_idx` (`hotel_id`);

--
-- Индексы таблицы `apartmentfacility`
--
ALTER TABLE `apartmentfacility`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_apartmentfacility_facility1_idx` (`facility_id`),
  ADD KEY `fk_apartmentfacility_apartment1_idx` (`apartment_id`);
...
ALTER TABLE `order`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_UNIQUE` (`id`),
  ADD KEY `fk_order_apartment1_idx` (`apartment_id`),
...
--
ALTER TABLE `apartment`
  ADD CONSTRAINT `fk_apartment_hotel1` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `apartmentfacility`
--
ALTER TABLE `apartmentfacility`
  ADD CONSTRAINT `fk_apartmentfacility_apartment1` FOREIGN KEY (`apartment_id`) REFERENCES `apartment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_apartmentfacility_facility1` FOREIGN KEY (`facility_id`) REFERENCES `facility` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `fk_order_apartment1` FOREIGN KEY (`apartment_id`) REFERENCES `apartment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
